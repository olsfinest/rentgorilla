    ...
    <fieldset>
		...
		<label for="price" class="required half left">Monthly Rent <i class="fa fa-info-circle" title="This value should reflect the total unit cost. Please note in your description if the price is per room."></i>
            {!! Form::text('price', null, ['class' => 'form-control', 'placeholder' => 'E.g., 500']) !!}
            Per Room? {!! Form::checkbox('per_room', 1, null) !!}
        </label>
		
        <label for="type" class="required half right">Type
            {!! Form::select('type', Config::get('rentals.type'), null, ['autocomplete' => 'off', 'class' => 'form-control']) !!}
        </label>
		
		<label for="floors" class="required half left">Flooring
            {!! Form::text('floors', null, ['class' => 'form-control', 'placeholder' => 'E.g., 4']) !!}
        </label>
        ...
        <label for="pets" class="required half left">Pets
        ...
        <label for="disability_access" class="required half left">Disability Access
            <span class="labelSpan">
            {!! Form::radio('disability_access', 1) !!} Yes {!! Form::radio('disability_access', 0) !!} No
            </span>
        </label>
        <label for="smoking" class="required half right">Smoking
            <span class="labelSpan">
            {!! Form::radio('smoking', 1) !!} Yes {!! Form::radio('smoking', 0) !!} No
            </span>
        </label>
        <label for="utilities_included" class="required half left">Utilities Included
            <span class="labelSpan">
    ...
    <label for="furnished" class="required half right">Furnished
        <span class="labelSpan">
	...
	<br/>
	<label for="laundry" class="required">Laundry
    ...
    <fieldset>
		...
		<label for="walkscore" class="">Walkscore
            {!! Form::text('walkscore', null, ['class' => 'form-control', 'placeholder' => 'E.g., 1 - 100 ']) !!}
    </label>
