...
class EditRentalCommand extends Command {
    ...
    function __construct($id, $street_address, $city, $county, $province, $type, $pets, $parking, $baths, $beds, $price, $deposit, $laundry, $disability_access, $smoking, $utilities_included, $heat_included, $furnished, $available, $lat, $lng, $lease, $description, $video, $per_room = null, $active = null, $square_footage = null, $feature_list = null, $appliance_list = null, $heat_list = null, $postal_code = null , $yearofconstruction , $yearofrenovation , $floors , $apartment , $safety_list = null , $occupancy_permit , $up_to_code , $walkscore)
    {
        $this->id = $id;
